...
#define		SSE2_H
#ifdef		__GNUC__
//disables SSE4.1 parts to avoid compilation error or crash on older CPUs
#define		__GCC_SUCKS__
#endif
#include	"g2_common.h"
...
namespace	G2
{
	...
	/*	Vect2d  r_r_random					(Vect2d const &x);
		...
		void r_rc_trwv_sse2				(VectP &r, VectP const &x, CompP const &y);
		void r_rq_trwv_sse2				(VectP &r, VectP const &x, QuatP const &y);
		void r_cr_trwv_sse2				(VectP &r, CompP const &x, VectP const &y);
		void r_cc_trwv_sse2				(VectP &r, CompP const &x, CompP const &y);
		void r_cq_trwv_sse2				(VectP &r, CompP const &x, QuatP const &y);
		void r_qr_trwv_sse2				(VectP &r, QuatP const &x, VectP const &y);
		void r_qc_trwv_sse2				(VectP &r, QuatP const &x, CompP const &y);
		void r_qq_trwv_sse2				(VectP &r, QuatP const &x, QuatP const &y);
		...
		void  r_c_saw_sse2				(VectP &r, CompP const &x);
		void  r_q_saw_sse2				(VectP &r, QuatP const &x);
		void r_rr_saw_sse2				(VectP &r, VectP const &x, VectP const &y);
		void r_rc_saw_sse2				(VectP &r, VectP const &x, CompP const &y);
		void r_rq_saw_sse2				(VectP &r, VectP const &x, QuatP const &y);
		void r_cr_saw_sse2				(VectP &r, CompP const &x, VectP const &y);
		void r_cc_saw_sse2				(VectP &r, CompP const &x, CompP const &y);
		void r_cq_saw_sse2				(VectP &r, CompP const &x, QuatP const &y);
		void r_qr_saw_sse2				(VectP &r, QuatP const &x, VectP const &y);
		void r_qc_saw_sse2				(VectP &r, QuatP const &x, CompP const &y);
		void r_qq_saw_sse2				(VectP &r, QuatP const &x, QuatP const &y);
