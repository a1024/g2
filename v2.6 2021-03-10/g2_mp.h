...
namespace		MP
{
	...
	struct		Quat
	{
		...
		Quat(Quat const &x):r(x.r), i(x.i), j(x.j), k(x.k){}
...
//#ifdef __GNUC__
		Quat& operator=(Quat const &x){r=x.r, i=x.i, j=x.j, k=x.k; return *this;}
//#endif
		Quat& operator=(Real &&x){r=x; return *this;}
		Quat& operator=(Comp &&x){r=std::move(x.r), i=std::move(x.i); return *this;}
//#ifdef __GNUC__
		Quat& operator=(Quat &&x){r=std::move(x.r), i=std::move(x.i), j=std::move(x.j), k=std::move(x.k); return *this;}
//#endif
	...
	void r_rc_trwv					(Quat &r, Quat const &x, Quat const &y);
	void r_rq_trwv					(Quat &r, Quat const &x, Quat const &y);
	void r_cr_trwv					(Quat &r, Quat const &x, Quat const &y);
	void r_cc_trwv					(Quat &r, Quat const &x, Quat const &y);
	void r_cq_trwv					(Quat &r, Quat const &x, Quat const &y);
	void r_qr_trwv					(Quat &r, Quat const &x, Quat const &y);
	void r_qc_trwv					(Quat &r, Quat const &x, Quat const &y);
	void r_qq_trwv					(Quat &r, Quat const &x, Quat const &y);

	void  r_r_saw					(Quat &r, Quat const &x);
	void  r_c_saw					(Quat &r, Quat const &x);
	void  r_q_saw					(Quat &r, Quat const &x);
	void r_rr_saw					(Quat &r, Quat const &x, Quat const &y);
	void r_rc_saw					(Quat &r, Quat const &x, Quat const &y);
	void r_rq_saw					(Quat &r, Quat const &x, Quat const &y);
	void r_cr_saw					(Quat &r, Quat const &x, Quat const &y);
	void r_cc_saw					(Quat &r, Quat const &x, Quat const &y);
	void r_cq_saw					(Quat &r, Quat const &x, Quat const &y);
	void r_qr_saw					(Quat &r, Quat const &x, Quat const &y);
	void r_qc_saw					(Quat &r, Quat const &x, Quat const &y);
	void r_qq_saw					(Quat &r, Quat const &x, Quat const &y);
...
//	void q_qq_hypot					(Quat &r, Quat const &x, Quat const &y);
	...
	void r_r_isprime				(Quat &r, Quat const &x);

	void r_r_totient				(Quat &r, Quat const &x);

	void r_rr_invmod				(Quat &r, Quat const &x, Quat const &y);
