			...
			if(exponent>=-13&&exponent<=50)
			{
				if(exponent<0)
				{
					...
					for(int k=52-(l2base+exponent%l2base)%l2base;k>=0&&mantissa;k-=l2base)
					{
						...
						offset+=sprintf_s(buffer+offset, buffer_size-offset, "%llX", digit);
					}
				}
...
struct				CompRef
{
	...
	CompRef& operator=(std::complex<double> const &other){r=other.real(), i=other.imag(); return *this;}
	CompRef& operator+=(std::complex<double> const &other){r+=other.real(), i+=other.imag(); return *this;}
	CompRef& operator-=(std::complex<double> const &other){r-=other.real(), i-=other.imag(); return *this;}
...
struct				QuatRef
{
	...
	QuatRef& operator=(boost::math::quaternion<double> const &other){r=other.R_component_1(), i=other.R_component_2(), j=other.R_component_3(), k=other.R_component_4(); return *this;}
	QuatRef& operator+=(boost::math::quaternion<double> const &other){r+=other.R_component_1(), i+=other.R_component_2(), j+=other.R_component_3(), k+=other.R_component_4(); return *this;}
	QuatRef& operator-=(boost::math::quaternion<double> const &other){r-=other.R_component_1(), i-=other.R_component_2(), j-=other.R_component_3(), k-=other.R_component_4(); return *this;}
};
...
struct				Value
{
	...
	Quat1d quat1d(){return Quat1d(r, i, j, k);}
...
namespace			MP
{
	union			FP//multiprecision function pointer
	{
		...
		FP():uf(nullptr){}
		FP(void (*p)()):uf((UF)p){}
	//	operator VF(){return (VF)uf;}
		FP& operator=(void (*p)()){uf=(UF)p; return *this;}//*/
	/*	enum	Type
		{
			NOOP_FUNCTION,
...
union				FP//function pointer
{
	...
	FP():r_r(nullptr){}
	FP(void (*p)()):r_r((R_R)p){}
	FP& operator=(void (*p)()){r_r=(R_R)p; return *this;}
//	operator VF(){return (VF)r_r;}
};
struct				FPSetter
{
	char type;
	...
	FP ia32, sse2, avx;
	MP::FP mp;
	FPSetter():ia32(nullptr), sse2(nullptr), avx(nullptr), mp(nullptr), type(0){}
	void set(){ia32=sse2=avx=nullptr, mp=nullptr, type=SIG_NOOP;}

	//non-simd setters
	void set(FP::R_R r_r,	MP::FP::UF mp_r_r)	{ia32.r_r=sse2.r_r=avx.r_r=r_r,	mp.uf=mp_r_r,	type=SIG_R_R, simd=false;}
	void set(FP::C_C c_c,	MP::FP::UF mp_c_c)	{ia32.c_c=sse2.c_c=avx.c_c=c_c,	mp.uf=mp_c_c,	type=SIG_C_C, simd=false;}
	void set(FP::Q_Q q_q,	MP::FP::UF mp_q_q)	{ia32.q_q=sse2.q_q=avx.q_q=q_q,	mp.uf=mp_q_q,	type=SIG_Q_Q, simd=false;}
	void set(FP::R_RR r_rr,	MP::FP::BF mp_r_rr)	{ia32.r_rr=sse2.r_rr=avx.r_rr=r_rr, mp.bf=mp_r_rr, type=SIG_R_RR, simd=false;}
	void set(FP::C_RC c_rc,	MP::FP::BF mp_c_rc)	{ia32.c_rc=sse2.c_rc=avx.c_rc=c_rc, mp.bf=mp_c_rc, type=SIG_C_RC, simd=false;}
	void set(FP::Q_RQ q_rq,	MP::FP::BF mp_q_rq)	{ia32.q_rq=sse2.q_rq=avx.q_rq=q_rq, mp.bf=mp_q_rq, type=SIG_Q_RQ, simd=false;}
	void set(FP::C_CR c_cr,	MP::FP::BF mp_c_cr)	{ia32.c_cr=sse2.c_cr=avx.c_cr=c_cr, mp.bf=mp_c_cr, type=SIG_C_CR, simd=false;}
	void set(FP::C_CC c_cc,	MP::FP::BF mp_c_cc)	{ia32.c_cc=sse2.c_cc=avx.c_cc=c_cc, mp.bf=mp_c_cc, type=SIG_C_CC, simd=false;}
	void set(FP::Q_CQ q_cq,	MP::FP::BF mp_q_cq)	{ia32.q_cq=sse2.q_cq=avx.q_cq=q_cq, mp.bf=mp_q_cq, type=SIG_Q_CQ, simd=false;}
	void set(FP::Q_QR q_qr,	MP::FP::BF mp_q_qr)	{ia32.q_qr=sse2.q_qr=avx.q_qr=q_qr, mp.bf=mp_q_qr, type=SIG_Q_QR, simd=false;}
	void set(FP::Q_QC q_qc,	MP::FP::BF mp_q_qc)	{ia32.q_qc=sse2.q_qc=avx.q_qc=q_qc, mp.bf=mp_q_qc, type=SIG_Q_QC, simd=false;}
	void set(FP::Q_QQ q_qq,	MP::FP::BF mp_q_qq)	{ia32.q_qq=sse2.q_qq=avx.q_qq=q_qq, mp.bf=mp_q_qq, type=SIG_Q_QQ, simd=false;}

	void set(FP::C_R c_r,	MP::FP::UF mp_c_r)	{ia32.c_r=sse2.c_r=avx.c_r=c_r,	mp.uf=mp_c_r,	type=SIG_C_R, simd=false;}
	void set(FP::C_Q c_q,	MP::FP::UF mp_c_q)	{ia32.c_q=sse2.c_q=avx.c_q=c_q,	mp.uf=mp_c_q,	type=SIG_C_Q, simd=false;}

	void set(FP::R_C r_c,	MP::FP::UF mp_r_c)	{ia32.r_c=sse2.r_c=avx.r_c=r_c,	mp.uf=mp_r_c,	type=SIG_R_C, simd=false;}
	void set(FP::R_Q r_q,	MP::FP::UF mp_r_q)	{ia32.r_q=sse2.r_q=avx.r_q=r_q,	mp.uf=mp_r_q,	type=SIG_R_Q, simd=false;}

	void set(FP::C_RR c_rr,	MP::FP::BF mp_c_rr)	{ia32.c_rr=sse2.c_rr=avx.c_rr=c_rr, mp.bf=mp_c_rr,	type=SIG_C_RR, simd=false;}
	
	void set(FP::R_RC r_rc,	MP::FP::BF mp_r_rc)	{ia32.r_rc=sse2.r_rc=avx.r_rc=r_rc, mp.bf=mp_r_rc,	type=SIG_C_RC, simd=false;}
	void set(FP::R_RQ r_rq,	MP::FP::BF mp_r_rq)	{ia32.r_rq=sse2.r_rq=avx.r_rq=r_rq, mp.bf=mp_r_rq,	type=SIG_R_RQ, simd=false;}
	void set(FP::R_CR r_cr,	MP::FP::BF mp_r_cr)	{ia32.r_cr=sse2.r_cr=avx.r_cr=r_cr, mp.bf=mp_r_cr,	type=SIG_R_CR, simd=false;}
	void set(FP::R_CC r_cc,	MP::FP::BF mp_r_cc)	{ia32.r_cc=sse2.r_cc=avx.r_cc=r_cc, mp.bf=mp_r_cc,	type=SIG_R_CC, simd=false;}
	void set(FP::R_CQ r_cq,	MP::FP::BF mp_r_cq)	{ia32.r_cq=sse2.r_cq=avx.r_cq=r_cq, mp.bf=mp_r_cq,	type=SIG_R_CQ, simd=false;}
	void set(FP::R_QR r_qr,	MP::FP::BF mp_r_qr)	{ia32.r_qr=sse2.r_qr=avx.r_qr=r_qr, mp.bf=mp_r_qr,	type=SIG_R_QR, simd=false;}
	void set(FP::R_QC r_qc,	MP::FP::BF mp_r_qc)	{ia32.r_qc=sse2.r_qc=avx.r_qc=r_qc, mp.bf=mp_r_qc,	type=SIG_R_QC, simd=false;}
	void set(FP::R_QQ r_qq,	MP::FP::BF mp_r_qq)	{ia32.r_qq=sse2.r_qq=avx.r_qq=r_qq, mp.bf=mp_r_qq,	type=SIG_R_QQ, simd=false;}

	void set(FP::C_QC c_qc,	MP::FP::BF mp_c_qc)	{ia32.c_qc=sse2.c_qc=avx.c_qc=c_qc, mp.bf=mp_c_qc,	type=SIG_C_QC, simd=false;}

	void set(FP::VAF vf,	MP::FP::VAF mp_vf)	{ia32.vf=sse2.vf=avx.vf=vf, mp.vf=mp_vf,	type=SIG_VA,	simd=false;}

	//simd setters
	void set(FP::R_R ia32_r_r,		FP::R_R sse2_r_r,	FP::R_R avx_r_r,	MP::FP::UF mp_r_r)	{ia32.r_r=ia32_r_r,		sse2.r_r=sse2_r_r,		avx.r_r=avx_r_r,	mp.uf=mp_r_r,	type=SIG_R_R,	simd=true;}
	void set(FP::C_C ia32_c_c,		FP::C_C sse2_c_c,	FP::C_C avx_c_c,	MP::FP::UF mp_c_c)	{ia32.c_c=ia32_c_c,		sse2.c_c=sse2_c_c,		avx.c_c=avx_c_c,	mp.uf=mp_c_c,	type=SIG_C_C,	simd=true;}
	void set(FP::Q_Q ia32_q_q,		FP::Q_Q sse2_q_q,	FP::Q_Q avx_q_q,	MP::FP::UF mp_q_q)	{ia32.q_q=ia32_q_q,		sse2.q_q=sse2_q_q,		avx.q_q=avx_q_q,	mp.uf=mp_q_q,	type=SIG_Q_Q,	simd=true;}
	void set(FP::R_RR ia32_r_rr,	FP::R_RR sse2_r_rr, FP::R_RR avx_r_rr,	MP::FP::BF mp_r_rr)	{ia32.r_rr=ia32_r_rr,	sse2.r_rr=sse2_r_rr,	avx.r_rr=avx_r_rr,	mp.bf=mp_r_rr,	type=SIG_R_RR,	simd=true;}
	void set(FP::C_RC ia32_c_rc,	FP::C_RC sse2_c_rc, FP::C_RC avx_c_rc,	MP::FP::BF mp_c_rc)	{ia32.c_rc=ia32_c_rc,	sse2.c_rc=sse2_c_rc,	avx.c_rc=avx_c_rc,	mp.bf=mp_c_rc,	type=SIG_C_RC,	simd=true;}
	void set(FP::Q_RQ ia32_q_rq,	FP::Q_RQ sse2_q_rq, FP::Q_RQ avx_q_rq,	MP::FP::BF mp_q_rq)	{ia32.q_rq=ia32_q_rq,	sse2.q_rq=sse2_q_rq,	avx.q_rq=avx_q_rq,	mp.bf=mp_q_rq,	type=SIG_Q_RQ,	simd=true;}
	void set(FP::C_CR ia32_c_cr,	FP::C_CR sse2_c_cr, FP::C_CR avx_c_cr,	MP::FP::BF mp_c_cr)	{ia32.c_cr=ia32_c_cr,	sse2.c_cr=sse2_c_cr,	avx.c_cr=avx_c_cr,	mp.bf=mp_c_cr,	type=SIG_C_CR,	simd=true;}
	void set(FP::C_CC ia32_c_cc,	FP::C_CC sse2_c_cc, FP::C_CC avx_c_cc,	MP::FP::BF mp_c_cc)	{ia32.c_cc=ia32_c_cc,	sse2.c_cc=sse2_c_cc,	avx.c_cc=avx_c_cc,	mp.bf=mp_c_cc,	type=SIG_C_CC,	simd=true;}
	void set(FP::Q_CQ ia32_q_cq,	FP::Q_CQ sse2_q_cq, FP::Q_CQ avx_q_cq,	MP::FP::BF mp_q_cq)	{ia32.q_cq=ia32_q_cq,	sse2.q_cq=sse2_q_cq,	avx.q_cq=avx_q_cq,	mp.bf=mp_q_cq,	type=SIG_Q_CQ,	simd=true;}
	void set(FP::Q_QR ia32_q_qr,	FP::Q_QR sse2_q_qr, FP::Q_QR avx_q_qr,	MP::FP::BF mp_q_qr)	{ia32.q_qr=ia32_q_qr,	sse2.q_qr=sse2_q_qr,	avx.q_qr=avx_q_qr,	mp.bf=mp_q_qr,	type=SIG_Q_QR,	simd=true;}
	void set(FP::Q_QC ia32_q_qc,	FP::Q_QC sse2_q_qc, FP::Q_QC avx_q_qc,	MP::FP::BF mp_q_qc)	{ia32.q_qc=ia32_q_qc,	sse2.q_qc=sse2_q_qc,	avx.q_qc=avx_q_qc,	mp.bf=mp_q_qc,	type=SIG_Q_QC,	simd=true;}
	void set(FP::Q_QQ ia32_q_qq,	FP::Q_QQ sse2_q_qq, FP::Q_QQ avx_q_qq,	MP::FP::BF mp_q_qq)	{ia32.q_qq=ia32_q_qq,	sse2.q_qq=sse2_q_qq,	avx.q_qq=avx_q_qq,	mp.bf=mp_q_qq,	type=SIG_Q_QQ,	simd=true;}

	void set(FP::C_R ia32_c_r,		FP::C_R sse2_c_r,	FP::C_R avx_c_r,	MP::FP::UF mp_c_r)	{ia32.c_r=ia32_c_r,		sse2.c_r=sse2_c_r,		avx.c_r=avx_c_r,	mp.uf=mp_c_r,	type=SIG_C_R,	simd=true;}
	void set(FP::C_Q ia32_c_q,		FP::C_Q sse2_c_q,	FP::C_Q avx_c_q,	MP::FP::UF mp_c_q)	{ia32.c_q=ia32_c_q,		sse2.c_q=sse2_c_q,		avx.c_q=avx_c_q,	mp.uf=mp_c_q,	type=SIG_C_Q,	simd=true;}

	void set(FP::R_C ia32_r_c,		FP::R_C sse2_r_c,	FP::R_C avx_r_c,	MP::FP::UF mp_r_c)	{ia32.r_c=ia32_r_c,		sse2.r_c=sse2_r_c,		avx.r_c=avx_r_c,	mp.uf=mp_r_c,	type=SIG_R_C,	simd=true;}
	void set(FP::R_Q ia32_r_q,		FP::R_Q sse2_r_q,	FP::R_Q avx_r_q,	MP::FP::UF mp_r_q)	{ia32.r_q=ia32_r_q,		sse2.r_q=sse2_r_q,		avx.r_q=avx_r_q,	mp.uf=mp_r_q,	type=SIG_R_Q,	simd=true;}

	void set(FP::C_RR ia32_c_rr,	FP::C_RR sse2_c_rr,	FP::C_RR avx_c_rr,	MP::FP::BF mp_c_rr)	{ia32.c_rr=ia32_c_rr,	sse2.c_rr=sse2_c_rr,	avx.c_rr=avx_c_rr,	mp.bf=mp_c_rr,	type=SIG_C_RR,	simd=true;}
	
	void set(FP::R_RC ia32_r_rc,	FP::R_RC sse2_r_rc,	FP::R_RC avx_r_rc,	MP::FP::BF mp_r_rc)	{ia32.r_rc=ia32_r_rc,	sse2.r_rc=sse2_r_rc,	avx.r_rc=avx_r_rc,	mp.bf=mp_r_rc,	type=SIG_R_RC,	simd=true;}
	void set(FP::R_RQ ia32_r_rq,	FP::R_RQ sse2_r_rq,	FP::R_RQ avx_r_rq,	MP::FP::BF mp_r_rq)	{ia32.r_rq=ia32_r_rq,	sse2.r_rq=sse2_r_rq,	avx.r_rq=avx_r_rq,	mp.bf=mp_r_rq,	type=SIG_R_RQ,	simd=true;}
	void set(FP::R_CR ia32_r_cr,	FP::R_CR sse2_r_cr,	FP::R_CR avx_r_cr,	MP::FP::BF mp_r_cr)	{ia32.r_cr=ia32_r_cr,	sse2.r_cr=sse2_r_cr,	avx.r_cr=avx_r_cr,	mp.bf=mp_r_cr,	type=SIG_R_CR,	simd=true;}
	void set(FP::R_CC ia32_r_cc,	FP::R_CC sse2_r_cc,	FP::R_CC avx_r_cc,	MP::FP::BF mp_r_cc)	{ia32.r_cc=ia32_r_cc,	sse2.r_cc=sse2_r_cc,	avx.r_cc=avx_r_cc,	mp.bf=mp_r_cc,	type=SIG_R_CC,	simd=true;}
	void set(FP::R_CQ ia32_r_cq,	FP::R_CQ sse2_r_cq,	FP::R_CQ avx_r_cq,	MP::FP::BF mp_r_cq)	{ia32.r_cq=ia32_r_cq,	sse2.r_cq=sse2_r_cq,	avx.r_cq=avx_r_cq,	mp.bf=mp_r_cq,	type=SIG_R_CQ,	simd=true;}
	void set(FP::R_QR ia32_r_qr,	FP::R_QR sse2_r_qr,	FP::R_QR avx_r_qr,	MP::FP::BF mp_r_qr)	{ia32.r_qr=ia32_r_qr,	sse2.r_qr=sse2_r_qr,	avx.r_qr=avx_r_qr,	mp.bf=mp_r_qr,	type=SIG_R_QR,	simd=true;}
	void set(FP::R_QC ia32_r_qc,	FP::R_QC sse2_r_qc,	FP::R_QC avx_r_qc,	MP::FP::BF mp_r_qc)	{ia32.r_qc=ia32_r_qc,	sse2.r_qc=sse2_r_qc,	avx.r_qc=avx_r_qc,	mp.bf=mp_r_qc,	type=SIG_R_QC,	simd=true;}
	void set(FP::R_QQ ia32_r_qq,	FP::R_QQ sse2_r_qq,	FP::R_QQ avx_r_qq,	MP::FP::BF mp_r_qq)	{ia32.r_qq=ia32_r_qq,	sse2.r_qq=sse2_r_qq,	avx.r_qq=avx_r_qq,	mp.bf=mp_r_qq,	type=SIG_R_QQ,	simd=true;}

	void set(FP::C_QC ia32_c_qc,	FP::C_QC sse2_c_qc,	FP::C_QC avx_c_qc,	MP::FP::BF mp_c_qc)	{ia32.c_qc=ia32_c_qc,	sse2.c_qc=sse2_c_qc,	avx.c_qc=avx_c_qc,	mp.bf=mp_c_qc,	type=SIG_C_QC,	simd=true;}

	void set(FP::VAF ia32_vf,		FP::VAF sse2_vf,	FP::VAF avx_vf,		MP::FP::VAF mp_vf)	{ia32.vf=ia32_vf,		sse2.vf=sse2_vf,		avx.vf=avx_vf,		mp.vf=mp_vf,	type=SIG_VA,	simd=true;}
#if 0
	//non-simd setters
...
//		cl_idx(0), cl_disc_idx(0), op2(-1), op3(-1), r_ms(0), op1_ms(0), op2_ms(0), op3_ms(0){}
	...
	//unary function
	Instruction(FPSetter &fps, int op1, char op1_ms, int result, char r_ms, DiscontinuityFunction const &d, int cl_idx, int cl_disc_idx):
	...
	//binary function
	Instruction(FPSetter &fps, int op1, char op1_ms, int op2, char op2_ms, int result, char r_ms, DiscontinuityFunction const &d, int cl_idx, int cl_disc_idx):
	...
	//inline if
	Instruction(int op1, char op1_ms, int op2, char op2_ms, int op3, char op3_ms, int result, char r_ms, DiscontinuityFunction const &d, int cl_idx, int cl_disc_idx):
